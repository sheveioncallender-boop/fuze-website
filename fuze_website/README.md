...
Checkout, contact and kitchen actions use Odoo 19's native JSON-RPC routes. The
browser sends named parameters and unwraps Odoo's result/error envelope, so
route errors remain machine-readable instead of becoming HTML error pages.
