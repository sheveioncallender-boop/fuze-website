...
class FuzeWebsite(http.Controller):
    ...
    def fuze_contact(self, **kwargs):
        return request.render(
            "fuze_website.fuze_contact_page",
            {"fuze_csrf_token": request.csrf_token()},
        )
    ...
    def create_order(self, **kwargs):
        ...
        payload = self._form_json_payload(kwargs)
    ...
    @http.route("/fuze/contact/submit", type="http", auth="public", website=True, methods=["POST"])
